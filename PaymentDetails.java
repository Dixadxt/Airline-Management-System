...
public class PaymentDetails extends JFrame{ //Fifth
	...
	add(Classname);
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("airlinemanagementsystem/icons/payment.png"));
            ...
            public void actionPerformed(ActionEvent ae){
                ...
                try {
                    String code  = textField.getText();
                     ...
                     Conn c = new Conn();
                    String query = "select pnr_no,paid_amt,pay_date,cheque_no,card_no,ph_no from payment where pnr_no = '"+code+"'";
